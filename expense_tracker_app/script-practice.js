// Original without updating the total 
...
window.addEventListener('load', () => {
    ...
    let totalExpenses = document.getElementById('total-expenses-container');
    ...
    valuesContainer.addEventListener('click', (e) => {
      ...
      function calculateTotalExpenses() {
        ...
        return totalExpenses.textContent = `Total Expenses = $${total.toFixed(2)}`;
      }
